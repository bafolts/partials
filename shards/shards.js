...
// We currently assume that we are always using requireJS wrapped.
// This means we at least need to include the require code base if it
// hasn't been included manually. In this situation we append the require framework to load.
